...
export default function About() {
    ...
    // let modeName = "Dark"
    const [modeSet, setModeName] = useState("Dark");
    const [darkMode, setMode] = useState(initialState);
            ...
            <div className="container my-2" style={darkMode}>
                ...
                <div className="accordion" id="accordionExample" >
                    <div className="accordion-item" style={darkMode}>
                        <h2 className="accordion-header" id="headingOne" style={darkMode}>
                    ...
                    <div className="accordion-item" style={darkMode}>
                        <h2 className="accordion-header" id="headingTwo" style={darkMode}>
                        ...
                        <div id="collapseTwo" style={darkMode} className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    ...
                    <div className="accordion-item" style={darkMode}>
                        <h2 className="accordion-header" id="headingThree" style={darkMode}>
                ...
                <button type="button" className="btn btn-primary my-3" onClick={handleMode}>Enable {modeSet} Mode</button>
            </div>
        </>
    );
}